...
/**
 * According to studies delays are not always recognized as delays by passengers. 
 * Therefore, this enumeration lists the delay types that correspond with humanoid perception.  
 * */
